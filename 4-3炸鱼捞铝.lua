...
local n=1
cg43={
[0]=function() return cgallbutflag({92,29,36,76,62}) end,  	--大井
function() return cgallbutflag({30,85,68,45,50}) end,		--北上
function() return cgallbutflag({87,27,22,19,34}	) end		--木曾
}
